...
class WallAnt(Ant):
    """WallAnt is a defensive ant with a large amount of health and no action."""

    name = 'Wall'
    food_cost = 4
    implemented = True  # Make sure it shows up in the GUI
...
def random_or_none(seq):
    """Return a random element from seq, or None if empty."""
    if seq:
...
class TankAnt(ContainerAnt):
    """TankAnt deals damage to all bees in its place while protecting another ant."""
